...
public class NaverLoginBo {
	...
	private final static String CLIENT_ID = "4Z46PfCSTq7IHwjThlL9";
	private final static String CLIENT_SECRET = "qgDYcGHQOf";
	private final static String REDIRECT_URI = "http://localhost:8787/upgrade/naverlogincallback.do";
