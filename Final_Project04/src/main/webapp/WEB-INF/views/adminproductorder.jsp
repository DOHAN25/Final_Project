                ...
                <div class="container" style="width: 100%;">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <table class="table" style="margin-top:40px;">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#"><button type="button"
                                                        class="btn btn-default btn-sm">수정</button></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>우편번호</th>
                                        ...
                                        <tr>
                                            <th>상세주소</th>
                                            <td> <input type="text" id="receiverDetailaddress"
                            ...
                            <div class="row">
                                <div class="col-md-4"><button id="requestPay"
                                        class="btn btn-primary btn-block">결제</button></div>
