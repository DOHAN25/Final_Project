		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse navbar-scrollspy" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a href="loginform.do" title="로그인"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span></a></li>
                       <li><a href="#" title="로그아웃" style="color:rgb(116,116,116)"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span></a></li>
                       <li><a href="registform.do"title="회원가입" style="color:rgb(116, 116, 116)"><span class="glyphicon glyphicon-registration-mark" aria-hidden="true"></span></a></li>
