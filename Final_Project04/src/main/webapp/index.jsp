	...
	<nav class="navbar navbar-default navbar-fixed-top ">
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="loginform.do" title="로그인"><span
							class="glyphicon glyphicon-log-in" aria-hidden="true"></span></a></li>
					<li><a href="#" title="로그아웃" style="color: rgb(116, 116, 116)"><span
							class="glyphicon glyphicon-log-out" aria-hidden="true"></span></a></li>
					<li><a href="registform.do" title="회원가입"
						style="color: rgb(116, 116, 116)"><span
							class="glyphicon glyphicon-registration-mark" aria-hidden="true"></span></a></li>
					<li><a href="#" title="마이페이지"
						style="color: rgb(116, 116, 116)"><span
	...
	<c:if test="${login != null }">
		<div class="container-fluid" id="section1">
			<a href="usermarketplace.do"><div class="col-md-12" id="text">
					...
					<div class="text">
						...
						<p id="img_content">내가 키운 채소, 당근팜에서 거래하기</p>
					</div>
				</div></a>
		</div>
		...
		<div class="container-fluid" id="section3">
			<a href="loginform.do"><div class="col-md-12" id="text">
					<img src="resources/image/주말농장_main1.jpg" alt="당근팜"
						style="width: 100%; height: 100%;">
					<div class="text">
						<p id="img_title">주말농장</p>
						<p id="img_content">주말농장 체험하러 가기</p>
					</div>
				</div></a>
		</div>
		...
		<div class="container-fluid" id="section4">
			<a href="main.do"><div class="col-md-12" id="text">
					...
					<div class="text">
						...
						<p id="img_content">나만의 농작물 키우기 꿀팁얻기</p>
					</div>
				</div></a>
		</div>
		...
		<div class="container-fluid" id="section5">
			<a href="weather.do"><div class="col-md-12" id="text">
					<img src="resources/image/날씨확인_main1.jpg" alt="당근팜"
						style="width: 100%;">
					<div class="text">
						<p id="img_title">날씨확인</p>
						<p id="img_content">오늘의 날씨를 확인해보세요</p>
					</div>
				</div></a>
		</div>
		...
		<div class="container-fluid" id="section6">
			<a href="noticeboardlist.do"><div class="col-md-12" id="text">
					<img src="resources/image/게시판_main1.jpg" alt="당근팜"
						style="width: 100%;">
					<div class="text">
						<p id="img_title">게시판</p>
						<p id="img_content">설명</p>
					</div>
				</div></a>
		</div>
		...
		<div class="container-fluid" id="section7">
			<a href="logOut.do"><div class="col-md-12" id="text">
					<img src="resources/image/로그인_main1.jpg" alt="당근팜"
						style="width: 100%;">
					<div class="text">
						<p id="img_title">로그아웃</p>
						<p id="img_content">설명</p>
					</div>
				</div></a>
		</div>
		...
		<div class="container-fluid" id="section7">
			<a href="loginform.do"><div class="col-md-12" id="text">
					<img src="resources/image/로그인_main1.jpg" alt="당근팜"
						style="width: 100%;">
					<div class="text">
						<p id="img_title">로그인</p>
						<p id="img_content">로그인을 해주세요</p>
					</div>
				</div></a>
		</div>
	</c:if>
	...
	<nav class="navbar navbar-default navbar-fixed-top ">
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<p class="navbar-text">
					내가 키운 채소, <a href="#" class="navbar-link">당근팜</a>에서 거래하세요!
				</p>
			</div>
